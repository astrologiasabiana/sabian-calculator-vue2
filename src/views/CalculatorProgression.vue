<template>
  <div>
    ...
    <section id="result">
      <MandalaHeliocentric v-if="r.helio" :result="r.progression.planets"></MandalaHeliocentric>
...
export default {
  ...
  methods:{
    ...
    set_progression(){
      ...
      this.r.progression.planets = this.addPlanetsInfo( this.r.progression.pl.getPlanets() )
